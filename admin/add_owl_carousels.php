          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">series_id</label>
                  <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control" type="file" name="cover_url">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <button type="submit" name="add_owl_carousels" class="btn btn-primary">Submit Form</button>
                      </div>
                    </div>
